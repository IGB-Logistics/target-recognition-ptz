...
MOBILENETV2_BOTTLENECK_WTS = os.path.join(current_file_path, "./weights/mobilenetv2_bottleneck_wts.pt")

current_file_path = os.path.dirname(os.path.realpath(__file__))
TORCHREID_OSNET_AIN_X1_0_MS_D_C_WTS = os.path.join(current_file_path, "./weights/osnet_ain_ms_d_c_wtsonly.pth")
